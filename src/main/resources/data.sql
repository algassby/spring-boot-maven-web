...
INSERT INTO INVOICE (ORDER_NUMBER,ID_CUSTOMER) VALUES
  ...
  ('BB123456781B',(select ID from CUSTOMER where NAME='Benny Hill'));
...
INSERT INTO INVOICE_LINE (ID_PRODUCT,QUANTITY,INVOICE_NUMBER) VALUES
  ...
  ((select ID from PRODUCT where NAME='Picnic Forks'),5,(select INVOICE_NUMBER from INVOICE where ORDER_NUMBER = 'BB123456781B'));